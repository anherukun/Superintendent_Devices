const char burst_html[] PROGMEM = R"rawliteral(
    <!DOCTYPE html>
    <html>
        ...
        <div class="d-grid gap-3 mb-3 ">
            ...
            <form class="d-grid gap-3 mb-3" action="/pgrm/load" method="GET">
                <div hidden>
                    ...
                    <input class="form-control" type="number" id="mode" name="mode" value="2" required>
                </div>

                <div hidden>
                    <label class="form-label" for="exp_t">Tiempo de Exposicion</label>
                    <select id="exp_t" class="form-select" name="exp_t" required>
                        <option selected value="0">Seleccione un tiempo</option>
                    </select>
                ...
                <div>
                    ...
                    <input class="form-control" list="datalistOptions" type="number" id="burst_c" name="burst_c"
                        required>
